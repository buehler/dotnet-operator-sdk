...
internal static class Rbac
{
    ...
    public static IEnumerable<V1PolicyRule> Transpile(this MetadataLoadContext context, IEnumerable<CustomAttributeData> attributes)
    {
        ...
        var generic = list
            ...
            {
                ApiGroups = a.GetCustomAttributeNamedStringArrayArg(nameof(GenericRbacAttribute.Groups)),
                Resources = a.GetCustomAttributeNamedStringArrayArg(nameof(GenericRbacAttribute.Resources)),
                NonResourceURLs = a.GetCustomAttributeNamedStringArrayArg(nameof(GenericRbacAttribute.Urls)),
                Verbs = ConvertToStrings(a.GetCustomAttributeNamedArg<RbacVerb>(context, nameof(GenericRbacAttribute.Verbs))),
            });
