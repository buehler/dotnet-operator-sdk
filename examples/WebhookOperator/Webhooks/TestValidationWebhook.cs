...
{
    public override async Task<ValidationResult> Create(V1TestEntity entity, bool dryRun)
    {
    ...
    public override async Task<ValidationResult> Update(V1TestEntity oldEntity, V1TestEntity newEntity, bool dryRun)
    {
